...
ruleTester.run("require-empty-line-after-file-tsdoc", requireEmptyLineAfterFileTSDocRule, {
  valid: [
    {
      filename: "module.ts",
      code: "/**\n * File docs.\n */\n\nexport const answer = 42;\n"
  ...
  invalid: [
    {
      ...
      errors: [
        {
          message: "There should be at least one empty line after the top-level file TSDoc comment."
        }
      ]
    },
    {
